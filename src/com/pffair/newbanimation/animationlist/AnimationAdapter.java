...
public abstract class AnimationAdapter extends BaseAdapterDecorator {
	...
	private void animateView(final ViewGroup parent, final View view) {
        ...
        final Animator shakeAnimator = ObjectAnimator.ofFloat(view, "x", -40,0);
        shakeAnimator.setInterpolator(new OvershootInterpolator());
        ...
        set.addListener(new AnimatorListener() {
			...
			public void onAnimationEnd(Animator arg0) {
			    ...
			    mAnimators.put(view.hashCode(), set2);
			}
